...
<body class="bg-background-light dark:bg-background-dark font-display text-gray-800 dark:text-gray-200">
    ...
    $marca = $marcaDAO->buscarMarca($_GET['id']);
    ?>
    <?php
    $mensaje = "";
    $clase_alerta = "";
            ...
            <div class="w-full max-w-lg space-y-8">
                <div>
                    ...
                    <p class="mt-2 text-center text-sm text-gray-600 dark:text-gray-400">
                        Edita una marca de motocicleta
                    </p>
                </div>
                <div
                    ...
                    <form action="../../controladores/MarcaController.php" class="space-y-6" method="POST">
                        <input type="hidden" name="id_marca" value="<?php echo htmlspecialchars($marca['id']); ?>">
                        <div>
                            ...
                            <div class="mt-1">
                                <input
                                    ...
                                    id="nombre_marca" name="nombre_marca" value="<?php echo $marca['nombre']; ?>"
                                    required="" type="text" />
                            </div>
                        </div>
